...
def listSubsetByKeywords(src_data, keyword):
...
def delListItemsWithKeywords(src_list, keyword):
...
def writeLists(file_path, data_all, parter=" "):
    if data_all is None:
        return
